...
for k in range(16):
    ...
    forest = forest_primer(model,final_set)
    joblib.dump(forest, "../test_bench/random_forest_10000_"+str(k)+".joblib")
    forest = joblib.load('../test_bench/random_forest_1000.joblib')
    # np.save('../../../../../../../datax/scratch/pma/real_filtered_LARGE_test_'+str(f_start)+'_'+target+'.npy', final_set[:])