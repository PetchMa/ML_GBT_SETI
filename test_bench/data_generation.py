from synthetic_real_dynamic import create_true, create_full_cadence, create_full_cadence_multicore, create_false, create_true_single_shot, create_true_faster
...
def create_data_set(plate, NUM_SAMPLES=10000, snr_base=20, snr_range = 10, factor=1, WIDTH_BIN=4096):
