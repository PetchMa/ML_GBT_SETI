...
memory_list =  [ 10000//2,10000//2,7000//2,10000//2]
...
for i in range(128, 357):
    ...
    result = classification_data(str(col), cadence_set, model,forest_set, "result_BLPC0/", iterations=16, batch_size=25000)
